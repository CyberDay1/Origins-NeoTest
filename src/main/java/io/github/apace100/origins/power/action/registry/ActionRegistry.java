...
public final class ActionRegistry {
    ...
    public static void bootstrap() {
        ...
        register(ModifyInventoryAction.TYPE, ModifyInventoryAction::fromJson);
        register(ClearInventoryAction.TYPE, ClearInventoryAction::fromJson);
        register(SwapInventoryAction.TYPE, SwapInventoryAction::fromJson);
        ...
        register(PreventEntitySpawnAction.TYPE, PreventEntitySpawnAction::fromJson);
