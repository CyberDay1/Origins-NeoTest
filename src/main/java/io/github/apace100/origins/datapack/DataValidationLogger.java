...
public final class DataValidationLogger extends SimplePreparableReloadListener<Void> {
    ...
    protected void apply(Void value, ResourceManager resourceManager, ProfilerFiller profiler) {
        ...
        Origins.LOGGER.info("[Origins] Datapack reload summary: {} origins, {} powers, {} actions ({} effect / {} attribute / {} item / {} food / {} block / {} projectile / {} experience / {} damage / {} fall / {} loot / {} recipe / {} sleep / {} restriction / {} inventory / {} spawn), {} conditions ({} effect / {} attribute / {} entity / {} composite / {} item / {} block / {} projectile / {} combat / {} environment / {} sleep / {} restriction / {} spawn / {} dimension / {} biome / {} dimension whitelist / {} biome whitelist)",
            ...
            stats.lootActionsLoaded(), stats.recipeActionsLoaded(), stats.sleepActionsLoaded(), stats.restrictionActionsLoaded(), stats.inventoryActionsLoaded(), stats.spawnActionsLoaded(),
            ...
            stats.combatConditionsLoaded(), stats.environmentConditionsLoaded(), stats.sleepConditionsLoaded(), stats.restrictionConditionsLoaded(), stats.spawnConditionsLoaded(),
            stats.dimensionConditionsLoaded(), stats.biomeConditionsLoaded(), stats.dimensionWhitelistConditionsLoaded(), stats.biomeWhitelistConditionsLoaded());
